...
{
	static const uint16 QUERY_PORT_NOT_INITIALIZED = 0xFFFF;	// We haven't asked the GS for this query port's actual value yet.
	static const uint16 QUERY_PORT_ERROR           = 0xFFFE;	// We were unable to get the query port for this server.
